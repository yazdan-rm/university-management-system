  ...
  return (
    <div className={clsx(className, "w-full ")}>
      ...
      >
        ...
        >
          <span className="text-11">نوار ناوبری</span>
        </div>
        ...
        <div className="flex flex-col w-3/4">
          ...
          >
            <span className="text-12">نوار ابزار</span>
          </div>
          ...
          <div className="flex flex-col w-full">
            ...
            >
              <span className="text-12">سربرگ (اولیه)</span>
            ...
            <div className="-mt-24 w-full pl-8 pr-28">
              ...
              >
                <span className="text-12">مقاله</span>
              </div>
            </div>

            <div className="w-full p-8">
              <span className="text-12">پس زمینه</span>
            </div>
          </div>
        </div>
      </button>
